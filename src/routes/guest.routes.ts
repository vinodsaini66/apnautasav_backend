...
import { createGuestSchema, updateGuestSchema } from '../validators/guest.validator';
...
router.post('/:weddingId/guests', checkWeddingAccess, checkPermission(CollaboratorRole.EDITOR), validate(createGuestSchema), GuestController.createGuest);
