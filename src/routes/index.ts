...
import seatingTableRoutes from './seating-table.routes';
import collaboratorRoutes from './collaborator.routes';
import activityRoutes from './activity.routes';
import notificationRoutes from './notification.routes';
import commentRoutes from './comment.routes';
import noteRoutes from './note.routes';
import guestNoteRoutes from './guestNote.routes';
...
router.use('/weddings', seatingTableRoutes);
...
router.use('/weddings', guestNoteRoutes);
